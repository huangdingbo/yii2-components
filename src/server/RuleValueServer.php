...
class RuleValueServer
{
     ...
     */
    public static function getPhoneNum($count,$type="array",$white_space=false){
        $arr = array(
        ...
        if($type==="string"){
            $tmp = Json::encode($tmp);//如果是字符串，解析成字符串
        }
        if($white_space===true){
    ...
    public static function getName($name_count = 1){
        $firstname_arr  = ['赵','钱','孙','李','周','吴','郑','王','冯','陈','褚','卫','蒋','沈','韩','杨','朱','秦','尤','许','何','吕','施','张','孔','曹','严','华','金','魏','陶','姜',
       ...
       $lastname_arr  = ['伟','刚','勇','毅','俊','峰','强','军','平','保','东','文','辉','力','明','永','健','世','广','志','义','兴','良','海','山','仁','波','宁','贵','福','生','龙',
