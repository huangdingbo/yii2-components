<?php
namespace dsj\components\widgets\selectmap;
...
class Map extends InputWidget
{
     ...
     * @var string
     */
    public $secret_key = 'a3b3d16e95cfd8d858300d093f839c5f';
    ...
    public function run()
    {
        ...
        return $this->render('index', [
            ...
            'boxId' => \common\helpers\StringHelper::uuid('uniqid')
        ]);
    }
    ...
    public function registerViewJs()
    {
        ...
        switch ($this->type) {
            case 'baidu' :
                ...
                break;
            case 'amap' :
                empty($this->secret_key) && $this->secret_key = Yii::$app->mapKey->config('map_amap_key');
//                empty($this->secret_key) && $this->secret_key = 'a3b3d16e95cfd8d858300d093f839c5f';
